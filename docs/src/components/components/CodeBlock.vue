...
import {EXAMPLE_STRINGS} from '../../assets/example-strings'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function parseModuleString() {
      const moduleString = EXAMPLE_STRINGS[props.file]
      return {
        template: getMatchedString(moduleString, template),
        script: getMatchedString(moduleString, script)
      }
    }
  }
  data() {
