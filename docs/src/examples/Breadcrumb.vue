<template>
  <nhs-breadcrumb>
    <nhs-breadcrumb-item href="/level-one">
      Level one
    </nhs-breadcrumb-item>
    ...
    <nhs-breadcrumb-backlink slot="backlink" href="/level-one/level-two/level-three">Back to Level three</nhs-breadcrumb-backlink>
  </nhs-breadcrumb>
</template>