...
import CheckboxSlots from '../../views/examples/checkbox/CheckboxSlots.vue?raw'
import CheckboxNonOfAbove from '../../views/examples/checkbox/CheckboxNonOfAbove.vue?raw'

const CHECKBOXES_STRINGS: ExampleStrings = {
  Checkbox,
  CheckboxHint,
  CheckboxDisabled,
  CheckboxHeading,
